...
void loop() {
  // put your main code here, to run repeatedly:
    ...
    for(int i = (FNZCP + 1); i< 125; i++){
      max_value = max(max_value, Rxx[i]);
    }
